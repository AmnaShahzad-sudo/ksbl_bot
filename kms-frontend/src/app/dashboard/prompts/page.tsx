  ...
  return (
    <div className="p-8 max-w-6xl mx-auto">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
        {[
          { label: "Active Prompts", value: prompts.length, icon: MessageSquare, bgColor: "bg-ksbl-navy/10", textColor: "text-ksbl-navy" },
          { label: "Engine Status", value: "Operational", icon: CheckCircle2, bgColor: "bg-green-50", textColor: "text-green-700" },
        ].map((stat, i) => (
